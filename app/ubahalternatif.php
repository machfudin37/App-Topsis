...
if (isset($_POST['ubah'])) {
    ...
    if ($s && mysqli_affected_rows($conn) > 0) {
        echo '<script>alert("Alternatif berhasil diubah"); window.open("alternatif.php", "_self");</script>';
    } else {
        echo '<script>alert("Alternatif gagal diubah"); window.history.back();</script>';
    }
}
...
<head>
    ...
    <title>Ubah Alternatif | App-Topsis</title>
