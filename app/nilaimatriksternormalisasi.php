...
<head>
    ...
    <title>Nilai Matriks Ternormalisasi | App-Topsis</title>
...
<body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100">
        ...
        <div class="container-lg px-4">
            <div class="card mb-4">
                <div class="card-header"><strong>Nilai Matriks Ternormalisasi</strong></div>
                <div class="card-body">
                    <div class="example">
		...
		<td>$da[nm_alternatif]</td>";
                                            ...
                                            while ($dn = mysqli_fetch_assoc($n)) {
                                                ...
                                                echo "<td align='center'>" . $nilai_matrik_ternormalisasi . '</td>';
                                            }
                                            echo "</tr>\n";
                                        }
                                        ?>
