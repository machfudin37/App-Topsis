...
if (isset($_POST["simpan"])) {
    ...
    if (isset($_FILES['excel_kriteria']['tmp_name'])) {
        $file = $_FILES['excel_kriteria']['tmp_name'];
        ...
        foreach ($objWorksheet->getRowIterator() as $row) {
            ...
            $sql = "INSERT INTO kriteria (id_kriteria, nama_kriteria, jenis, bobot) VALUES ('" . $data[0] . "', '" . $data[1] . "', '" . $data[2] . "' , '" . $data[3] . "')";
            if ($conn->query($sql) !== TRUE) {
                echo '<script>alert("Excel berhasil diimport"); window.open("kriteria.php", "_self");</script>';
            }
        }
    } else {
...
<head>
    ...
    <title>Import Excel Kriteria | App-Topsis</title>
...
<body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100">
        ...
        <div class="container-lg px-4">
            <div class="card mb-4">
                <div class="card-header"><strong>Import Excel Kriteria</strong></div>
                <div class="container-lg px-4">
                    <br>
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="input-group mb-3">
                            <input class="form-control" name="excel_kriteria" id="excel_kriteria" type="file"
