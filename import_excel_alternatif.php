...
if (isset($_POST["simpan"])) {
    ...
    if (isset($_FILES['excel_alternatif']['tmp_name'])) {
        $file = $_FILES['excel_alternatif']['tmp_name'];
        ...
        foreach ($objWorksheet->getRowIterator() as $row) {
            ...
            $sql = "INSERT INTO alternatif (id_alternatif, nm_alternatif) VALUES ('" . $data[0] . "', '" . $data[1] . "')";
            if ($conn->query($sql) !== TRUE) {
                echo '<script>alert("Excel berhasil diimport"); window.open("alternatif.php", "_self");</script>';
            }
        }
    } else {
...
<head>
    ...
    <title>Import Excel Alternatif | App-Topsis</title>
...
<body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100">
        ...
        <div class="container-lg px-4">
            <div class="card mb-4">
                <div class="card-header"><strong>Import Excel Alternatif</strong></div>
                <div class="container-lg px-4">
                    <br>
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="input-group mb-3">
                            <input class="form-control" name="excel_alternatif" id="excel_alternatif" type="file"
